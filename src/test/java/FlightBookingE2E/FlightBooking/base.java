...
public class base {
	...
	public static WebDriver initializeDriver() throws IOException  //void changed to WebDriver
	{
		...
		//This****1st way to use base properties file***********
		...
		//This****2nd way to use base properties file***********
		
		//String propFilePath = System.getProperty("user.dir")+"/src/main/java/E2EDemoTesting/data.properties";
		//FileInputStream fis = new FileInputStream(propFilePath);
		
		
		//C:\Users\DELL\eclipse-workspace\TestNG Practice\FlightBooking\src\test\java\FlightBookingE2E\FlightBooking\data.properties
		//This****3rd way to use base properties file***********
		String directoryPath = System.getProperty("user.dir");
		FileInputStream fis = new FileInputStream(directoryPath+"/src/test/java/FlightBookingE2E/FlightBooking/data.properties");
